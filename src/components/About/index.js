  ...
  return (
    <section className="flex flex-wrap justify-center">
      <div className="text-2xl w-1/2 mt-10 ml-10">
        ...
        <p className="mt-12">
          I am a well-developed professional with extensive Operations
          Management and Organizational Leadership experience.
        </p>
        <p className="mt-6">
          I graduated from the David Eccles School of Business at the University
          of Utah with a Bachelor of Science degree in Operations Management.
        </p>
        <p className="mt-6">
          I have completed a full-stack developer bootcamp to obtain critical
